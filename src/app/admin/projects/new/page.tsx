...
export default function CreateProjectPage() {
  ...
  const onSubmit = async (data: ProjectFormData) => {
    ...
    try {
      ...
      toast({ title: 'Success!', description: `Project "${data.title}" has been created.` });
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
        ...
        <p className="text-muted-foreground">Fill out the details below to add a new project.</p>
        <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="e.g., Build a Personal Portfolio Website" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
